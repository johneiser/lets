...
class Mshta(DockerExtension, Module):
    """
    Format a powershell script into an obfuscated cmd.exe command by 
    setting and using an environment variable within an mshta script
    ...
    def do(self, data:bytes=None, options:dict=None) -> bytes:
        ...
        cmd = "Invoke-Obfuscation -Quiet -ScriptPath /data/in -Command 'LAUNCHER,MSHTA++,%s' | Out-File /data/out" % (flags if flags else "0")
