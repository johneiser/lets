...
class Rundll32(DockerExtension, Module):
    ...
    setting and using an environment variable within a call to
    rundll32.exe for the command content.
    """
    FLAGS = [
        "None",
        "NoExit",
    ...
    def do(self, data:bytes=None, options:dict=None) -> bytes:
        ...
        cmd = "Invoke-Obfuscation -Quiet -ScriptPath /data/in -Command 'LAUNCHER,RUNDLL++,%s' | Out-File /data/out" % flags
