...
class Wmic(DockerExtension, Module):
    """
    Format a powershell script into an obfuscated cmd.exe command using wmic.
    """
    FLAGS = [
        "None",
        "NoExit",
    ...
    def do(self, data:bytes=None, options:dict=None) -> bytes:
        ...
        cmd = "Invoke-Obfuscation -Quiet -ScriptPath /data/in -Command 'LAUNCHER,WMIC,%s' | Out-File /data/out" % (flags if flags else "0")
