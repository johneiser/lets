...
class Cmd(DockerExtension, Module):
    """
    Format a powershell script into an obfuscated cmd.exe by passing
    the command content through the clipboard and executing an extra
    cmd.exe.
    """
    FLAGS = [
        "None",
    ...
    def do(self, data:bytes=None, options:dict=None) -> bytes:
        ...
        cmd = "Invoke-Obfuscation -Quiet -ScriptPath /data/in -Command 'LAUNCHER,CLIP++,%s' | Out-File /data/out" % flags
