...
class Base64(DockerExtension, Module):
    ...
    def test(self):
        ...
        self.assertEqual(
            ...
            b"IEX ([System.Text.Encoding]::UTF8.GetString([System.Convert]::FromBase64String('')))",
