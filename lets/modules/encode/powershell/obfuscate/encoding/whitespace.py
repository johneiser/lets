...
class Whitespace(DockerExtension, Module):
    """
    Obfuscate a powershell script with encoding-based manipulation using
    whitespace.
    """
    ...
    def do(self, data:bytes=None, options:dict=None) -> bytes:
        ...
        # Build command
        cmd = "Invoke-Obfuscation -Quiet -ScriptPath /data/in -Command 'ENCODING,8' | Out-File /data/out" % self.options
